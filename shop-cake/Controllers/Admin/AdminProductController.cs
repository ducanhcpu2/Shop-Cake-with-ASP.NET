...
namespace shop_cake.Controllers.Admin
{
    public class AdminProductController : Controller
    {
        ...
        public ActionResult Index(int? page) 
        {
            ...
            select new product_types() { id_product= p.id_product, product_name =  p.name, image= p.image,
                unit_price = p.unit_price, promotion_price= p.promotion_price, product_types_name = c.name,
